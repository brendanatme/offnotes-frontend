  ...
  return (
    <>
      <div className="flex flex-col h-screen w-screen bg-neutral-100 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-200">
        <header className="h-14 shrink-0 flex items-center justify-between px-6 border-b border-neutral-300 dark:border-neutral-500 bg-neutral-100 dark:bg-neutral-800">
